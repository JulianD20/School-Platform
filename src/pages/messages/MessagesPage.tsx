...
import { Plus, Search, Send, Inbox, TentIcon as SentIcon, Star, Trash2 } from 'lucide-react';
...
const mockMessages: Message[] = [
  {
    ...
    subject: 'Progreso académico de Diego',
    content: 'Quería informarle sobre el excelente progreso que ha mostrado Diego en matemáticas este período...',
    isRead: false,
  ...
  },
  {
    ...
    recipientId: '1',
    recipientName: 'María González',
    subject: 'Consulta sobre reunión de padres',
    content: 'Buenos días, quería confirmar la fecha y hora de la próxima reunión de padres...',
    isRead: true,
  ...
  },
  {
    ...
    subject: 'Comunicado sobre exámenes finales',
    content: 'Por favor confirme las fechas de los exámenes finales para el período actual...',
    isRead: true,
...
export function MessagesPage() {
  ...
  const filteredMessages = messages.filter(message => {
    ...
    const matchesTab = selectedTab === 'inbox' ? 
      message.recipientId === '1' : // Current user ID
      message.senderId === '1';
    
    return matchesSearch && matchesTab;
  });

  const unreadCount = messages.filter(m => !m.isRead && m.recipientId === '1').length;
      ...
      >
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Comunicación interna del sistema escolar
          </p>
        </div>
