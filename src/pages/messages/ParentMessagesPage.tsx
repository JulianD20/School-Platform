...
const mockMessages: Message[] = [
  {
    ...
    content: 'Estimada Sra. López, quería informarle sobre el excelente progreso que ha mostrado Diego en matemáticas...',
    isRead: false,
  ...
  },
  {
    ...
    content: 'Buenos días profesor, quería consultarle sobre las tareas de esta semana...',
    isRead: true,
...
export function ParentMessagesPage() {
  ...
  const filteredMessages = messages.filter(message => {
    ...
    const matchesTab = selectedTab === 'inbox' ? 
      message.recipientId === '3' : // Current parent ID
      message.senderId === '3';
    
    return matchesSearch && matchesTab;
  });

  const unreadCount = messages.filter(m => !m.isRead && m.recipientId === '3').length;
