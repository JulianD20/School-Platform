...
const mockMessages: Message[] = [
  {
    ...
    subject: 'Consulta sobre el progreso de Diego',
    content: 'Buenos días profesor, quería consultarle sobre el progreso de mi hijo Diego en matemáticas...',
    isRead: false,
  ...
  },
  {
    ...
    content: 'Estimado profesor, necesitamos coordinar una reunión para revisar los planes de estudio...',
    isRead: true,
...
export function TeacherMessagesPage() {
  ...
  const filteredMessages = messages.filter(message => {
    ...
    const matchesTab = selectedTab === 'inbox' ? 
      message.recipientId === '2' : // Current teacher ID
      message.senderId === '2';
    
    return matchesSearch && matchesTab;
  });

  const unreadCount = messages.filter(m => !m.isRead && m.recipientId === '2').length;
